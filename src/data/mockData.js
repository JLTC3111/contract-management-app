...
const INITIAL_MOCK_CONTRACTS = [
  ...
  },
  {
    ...
    title_i18n: 'demoSamples.projects.sample_contract_7',
    description_i18n: 'demoSamples.projects.sample_contract_7_description',
    status: 'completed',
    author: 'Demo User',
    author_id: 'demo-user-id',
    version: 'Final',
    ...
    description: 'Completed vendor partnership agreement with all phases signed off.',
  ...
  },
  {
    ...
    title_i18n: 'demoSamples.projects.sample_contract_8',
    description_i18n: 'demoSamples.projects.sample_contract_8_description',
    status: 'in_progress',
    author: 'Demo User',
    author_id: 'demo-user-id',
    version: '1.1',
    ...
    description: 'Ongoing infrastructure upgrade with active lifecycle phases.',
  ...
  },
  {
    ...
    title_i18n: 'demoSamples.projects.sample_contract_9',
    description_i18n: 'demoSamples.projects.sample_contract_9_description',
    status: 'rejected',
    author: 'Demo User',
    author_id: 'demo-user-id',
    version: '1.0',
    ...
    description: 'Rejected due to non-compliant terms in the liability section.',
